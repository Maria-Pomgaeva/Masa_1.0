...
var _menuOpen = require("./modules/menu-open");
...
},{"./modules/accordions/init-accordion":3,"./modules/form-validate/form":6,"./modules/map":12,"./modules/menu-open":13,"./modules/modals/init-modals":14,"./modules/select/custom-select":17,"./modules/swiper":19,"./utils/ios-vh-fix":22}],2:[function(require,module,exports){
"use strict";
...
},{"../utils/focus-lock":20,"../utils/scroll-lock":23}],5:[function(require,module,exports){
"use strict";
...
var initMap = function initMap() {
  ...
  var mapBlock = mapContainer ? mapContainer.querySelector('[data-map]') : null;
  var lMap = window.L;
  var map = lMap.map(mapBlock, {
...
var onOverlayClose = function onOverlayClose(evt) {
  evt.preventDefault();
  var target = evt.target;
  if (target === overlay) {
    burger._closeMenu();
...
},{"./burger":4}],14:[function(require,module,exports){
"use strict";
...
var initSwiper = function initSwiper() {
  var promoImage = new window.Swiper('.promo__swiper-image', {
    slidesPerView: 1,
    // loop: true,
  ...
  var promoContent = new window.Swiper('.promo__swiper-content', {
    slidesPerView: 1,
    effect: 'fade',
    autoHeight: true,
    fadeEffect: {
  ...
  // eslint-disable-next-line
  var programSwiper = new window.Swiper('.program__swiper', {
    navigation: {
  ...
  // eslint-disable-next-line
  var newsSwiper = new window.Swiper('.news__swiper', {
    pagination: {
      el: '.news__pagination',
      clickable: true,
      bulletActiveClass: 'is-active',
